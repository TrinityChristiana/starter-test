...
// Objects and Arrays
// 1. Grab the code from V2
// 2. grab the user input and set its value to an object
// 3. create an operation array
// 4. check if the user input is included in the array if not, return "Please fix the calculation"
